...
class CreateTableEveCharacterIndustryJobs extends Migration {
    ...
    public function up()
    {
        Schema::create('eve_character_industryjobs', function(Blueprint $table)
        {
            $table->increments('id');
            // Columns 
            $table->integer('jobID');
    ...
    {
        Schema::dropIfExists('eve_character_industryjobs');
    }
