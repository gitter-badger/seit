...
@section('html_title', 'Industry Facilities')
...
<div class="row">
  <div class="col-md-12">
    ...
    <div class="box box-primary" id="result-box" style="display: none;">
      <div class="box-header">
        <h3 class="box-title" id="result-box-title">Regional Facility Data</h3>
      </div>
      <div class="box-body">
        <div id="result">
        </div>
...
$('#regionsMap').on('change', function(e) {
      ...
      if (e.val.length > 0) { // Don't try and search for nothing
        ...
        $.ajax({
          type: 'post',
          url: "{!! action('CrestDataController@postIndustryFacilityData') !!}",
          data: {
            'regionID': e.val,
